...
```{r on-perl, fig.align="center", out.width="100%"}
knitr::include_graphics("images/on_perl.png")
```

<p style="margin: 2em 0; padding: 0.5em 1em; font-size: 75%; color: #666666; background-color: #EEEEEE;">
[On Perl](http://www.threepanelsoul.com/comic/on-perl) from [Three Panel Soul](http://www.threepanelsoul.com/).
</p>
