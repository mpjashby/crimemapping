...
the answer `NA`, because there is no way to know if the missing value 
  ...
  group_by(
    mutate(
      filter(
        ...
        as.Date(date_time) < as.Date("2019-02-01")
      ),
...
the reference to the column `weekday` on line 13 of this code belongs to the 
`group_by()` function on line 2.

<a href="https://magrittr.tidyverse.org/" title="magrittr website"><img src="images/magrittr.png" class="right-side-image"></a>
