...
square root of. Type `sqrt(2)` in the box below and click `Run Code` to 
...
We can use `read_csv()` to load data from `https://github.com/mpjashby/crimemapping/raw/main/inst/extdata/san_francisco_robbery.csv` 
