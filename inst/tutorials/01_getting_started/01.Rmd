...
In the "Workspace" section of the right-hand panel, find an option that says "Restore .RData into workspace at startup" and make sure the checkbox to the left of that option is **not checked**. On the next line down, click the drop-down menu labelled "Save workspace to .RData on exit:" and choose the option **Never**. Click `Apply` and then `OK` to close the dialogue box.
