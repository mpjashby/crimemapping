...
```{r markdown-flowchart, eval=FALSE}
library(Gmisc)
...
<p class="full-width-image"><img src="images/quarto-process.png" alt="A schematic representing the multi-language input (e.g. Python, R, Observable, Julia) and multi-format output (e.g. PDF, html, Word documents, and more) versatility of Quarto."></p>
...
<p class="credits">Artwork from "<a href="https://allisonhorst.com/cetinkaya-rundel-lowndes-quarto-keynote">Hello, Quarto</a>" keynote by Julia Lowndes and Mine Çetinkaya-Rundel, presented at RStudio Conference 2022. Illustrated by Allison Horst.</p>
