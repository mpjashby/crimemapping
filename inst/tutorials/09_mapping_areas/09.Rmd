...
cdmx_north_car_jacking_kde <- cdmx_north_car_jacking |> 
  sfhotspot::hotspot_kde(
    grid = sfhotspot::hotspot_grid(cdmx_north_boroughs, cell_size = 200), 
...
cdmx_north_maps$point <- ggplot(cdmx_north_car_jacking) +
  annotation_map_tile(type = "cartolight", zoomin = 0) +
  geom_sf(data = cdmx_north_boroughs, colour = "grey50", fill = NA) +
  geom_sf(alpha = 0.25, colour = "darkred", size = 0.5) +
  geom_sf_label(
...
cdmx_north_maps$density <- ggplot(cdmx_north_car_jacking_kde) +
  annotation_map_tile(type = "cartolight", zoomin = 0) +
  geom_sf(aes(fill = kde), colour = NA, alpha = 0.75) +
  geom_sf(data = cdmx_north_boroughs, colour = "grey50", fill = NA) +
  geom_sf_text(
    aes(label = str_wrap(nomgeo, 10)), 
    data = cdmx_north_boroughs, 
...
cdmx_north_maps$count <- ggplot(cdmx_north_car_jacking_count) +
  annotation_map_tile(type = "cartolight", zoomin = 0) +
  geom_sf(aes(fill = n), colour = "grey50") +
  geom_sf_text(
...
cdmx_north_map <- patchwork::wrap_plots(cdmx_north_maps, ncol = 3)
...
<p class="full-width-image"><img src="images/cdmx_north_map.jpg" alt="Three maps: a point map, a density map and a thematic/choropleth map"></p>
...
cdmx_car_jacking <- st_read("https://mpjashby.github.io/crimemappingdata/cdmx_car_jacking.gpkg") 
...
cdmx_alcaldias <- st_read("https://mpjashby.github.io/crimemappingdata/cdmx_alcaldias.gpkg")
```
