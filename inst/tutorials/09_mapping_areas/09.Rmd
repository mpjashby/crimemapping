...
Due to a bug on some versions of Windows, the R code chunks in this section are
not interactive. If you would like to run the R code here, please copy and paste
it into the R console or a blank R script (`.R`) file.
...
```{r interactive-map, out.width="100%", fig.asp=1, eval=FALSE}
colours_red <- colorNumeric(palette = "Reds", domain = NULL)
