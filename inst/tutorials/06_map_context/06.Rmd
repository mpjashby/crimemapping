...
quiz(
  ...
  question(
    "Which types of shapes are more likely to move an element up the visual hierarchy?",
    answer("Shapes that are simpler", correct = TRUE),
    answer("Shapes that are more complicated"),
    correct = random_praise(),
    allow_retry = TRUE,
    random_answer_order = TRUE
  )
